...
> [!seealso] Le bilan des banques commerciales et celui corrigé de la BC
...
- Une **expansion monétaire** (↘*i* ⇔ ↗*M*) déplace la courbe LM vers le bas, entraînant une **baisse du taux d'intérêt et une hausse de la production**. 
...
- Le taux d'intérêt sur les titres dépend à la fois de la **probabilité de défaut de l'emprunteur** (celui qui émet le titre) et du **degré d'aversion au risque du prêteur** (celui qui détient le titre). Une probabilité plus élevée d'aversion au risque ou de défaut conduit à un taux d'intérêt plus élevé.
...
> [!seealso] La crise financière de 2008 et l'effet des politiques financières, budgétaires et financières
...
**⇒ A. W. PHILLIPS, « The Relation between Unemployment and the Rate of Change of Money Wage Rates in the United Kingdom », *Economica*, 1958***
...
### 3. Retour sur les politiques de consolidation budgétaire 
...
> [!seealso] Une double relation entre production et capital
...
- Le taux de croissance de la production à l'état stationnaire est **indépendant du** **taux d'épargne**. Cependant, une augmentation du taux d'épargne génère de la croissance pour un temps, à un niveau supérieur à celui du sentier de croissance équilibrée. 
...
## <u>XIII. Anticipations, consommation et investissement</u>
...
> [!seealso] Les effets de la réduction du déficit sur la production
...
> [!seealso] Taux de change nominal, appréciation et dépréciation
...
$$\boxed{1+i_t=(\frac{1}{E_t})(1+i^*_t)E^e_{t+1}\Rightarrow i_t≈i^*_t+\frac{E^e_{t+1}-E_t}{E_t}}$$
...
> [!seealso] La réduction du déficit commercial sans changement de produit : une combinaison de la politique de change et de la politique budgétaire 
> ![[CamScanner 02-17-2024 14.39.jpg|center|500]]
> ![[CamScanner 02-17-2024 14.39_2.jpg|center|500]]

### 5. L’étude dynamique : la courbe en J

- Il faut du temps pour que les consommateurs se rendent compte du changement des prix relatifs. Ainsi, **la réponse typique de la balance commerciale à une dépréciation réelle est d'abord une détérioration, puis une amélioration**. Ce processus d'ajustement s'appelle « **courbe en J** ». Les études économétriques estiment la durée de l’**effet prix** entre six mois et un an. Ainsi, une dépréciation a tout d’abord un effet récessif (↓*NX* ⇒↓*Y*). 

<div style="page-break-after: always;"></div>



> [!seealso] La courbe en J
> $$\boxed{\displaylines{\begin{align*}
...
- La condition d'équilibre sur le marché des biens peut être réécrite comme la condition que l'épargne (privée et publique) moins l'investissement soit égale à la balance commerciale. Un **surplus commercial** correspond à un **excès de l'épargne** par rapport à l'investissement, un **déficit commercial** à un **excès de l'investissement**.
$$\boxed{STC\simeq NX=(S-I)+(T-G)}$$
- Cette équation a plusieurs implications : 
	- Une **augmentation de l’investissement** doit être compensée soit par une augmentation de l’épargne privée ou publique, soit par une détérioration de la balance commerciale (surplus commercial plus faible ou déficit commercial plus élevé). 
	- Une **augmentation du déficit budgétaire** doit être compensée par une augmentation de l’épargne privée, une diminution de l’investissement ou une détérioration de la balance commerciale. 
	- Un **pays avec un fort taux d’épargne privée ou publique**, doit avoir soit un fort taux d’investissement, soit un fort excédent commercial. 
- Mais ⚠ un déficit budgétaire n’induit pas forcément un déficit commercial, une augmentation de l’épargne privée ou une diminution de l’investissement. 
- De même, une **augmentation de la demande étrangère** induit une augmentation de l’épargne privée, une augmentation moindre de l’investissement, aucune variation du déficit budgétaire et une amélioration de la balance commerciale. 
- Ainsi, aux **États-Unis, le déficit du compte courant** (*STC* ≈ *X–M*) **s’explique par des niveaux d’épargne privée et d’épargne publique insuffisants** (baisse des impôts par l’administration Bush depuis 2001 puis crise de 2008 dont l’effet négatif sur les finances publiques domine l’effet positif sur celle des ménages) et non par d’importants investissements. Les **États-Unis  semble donc nécessiter une dépréciation du dollar** (car la politique monétaire est inefficace du fait du plancher zéro et le déficit public déjà important) pour réduire *NX*. **Mais il y a peu de pression en ce sens du fait de la présence de nombreux investisseurs internationaux prêts à financer le déficit du *STC* américain**.

<div style="page-break-after: always;"></div>


## <u>XVII. La production, le taux d’intérêt et le taux de change</u>

**⇒ Marcus FLEMING, 1962**

**⇒ Robert MUNDELL, 1963**

- Le taux de change n’est pas un instrument au service du gouvernement car il fixé sur le marché des changes. Qu’est-ce qui le détermine ? Comment le gouvernement peut-il tout de même le modifier ? C’est ce que permet de déterminer le **modèle Mundell-Fleming** (1962-63). Ce modèle suppose vérifiée la **condition de Marshall-Lerner**. On l’étendra ensuite en prenant en compte la contrainte de plancher zéro et le rôle du risque sur les décisions financières. 

### 1. L’équilibre sur le marché des biens 
$$\boxed{(IS) : Y=C\underset{(+)}{(Y-T)}+I\underset{(+,-)}{(Y,i)}+G+NX\underset{(-,+,+)}{(Y,Y^*,E)}}$$
- En économie ouverte, **la demande de biens dépend à la fois du taux d'intérêt et du taux de change**. Une diminution du taux d'intérêt augmente la demande de biens; une hausse du taux de change – une dépréciation – augmente aussi la demande de biens.
- On se place à **court terme** et donc on suppose que les niveaux des prix intérieurs et extérieurs sont donnés. Donc le taux de change réel (*Ɛ*) et le taux de change nominal (*E*) évoluent au même rythme. Pour simplifier on considère que le rapport des prix est unitaire. Donc ***Ɛ* = *E***. Il n’y a donc pas non plus d’inflation ni d’inflation anticipée et donc ***r* = *i***. 
### 2. L’équilibre sur les marchés financiers 

- On ajoute au choix entre monnaie et titres le choix entre **obligations étrangères** et **obligations nationales** (les investisseurs cherchent le rendement le plus élevé). Donc l’équilibre implique l’**égalisation des taux de rendement** (relation approximative car les investisseurs tiennent compte du risque et de la liquidité qui peut entraîner des **fuites massives de capitaux** comme ce fût le cas dans les pays émergents comme le Brésil après 2008). 
- Le **taux d'intérêt** est déterminé par l'égalité de l'offre et la demande de monnaie. Le **taux de change** est défini par la **condition de parité des taux d'intérêt**, qui affirme que le taux d'intérêt intérieur doit être égal au taux d'intérêt étranger plus le taux anticipé de dépréciation.
...
- L’ampleur de l’appréciation dépend des anticipations de dépréciation à venir (si la monnaie s’apprécie on anticipe qu’elle se dépréciera et les titres étrangers deviennent intéressant). **Il faut que l’appréciation initiale compense la dépréciation future anticipée** pour rester à l’équilibre. 

### 3. L’interaction des marchés des biens et des marchés financiers 

- Le **modèle *IS/LM* en économie ouverte** montre que le taux d’intérêt altère le produit non seulement directement en baissant l’investissement mais aussi indirectement par le canal du taux de change.

> [!seealso] La relation *IS/LM* en économie ouverte
> ![[CamScanner 02-20-2024 16.27_2.jpg|center|500]]

### 4. Les effets des politiques macroéconomiques en économie ouverte
  
- En **régime de change flexible, une politique budgétaire expansionniste** induit une augmentation du produit (via la consommation, l’investissement et les dépenses publiques) sans modification du taux de change si la banque centrale ne réagit pas. Cela implique aussi une détérioration de la balance commerciale par le canal du produit intérieur. 
- **Si la banque centrale juge que ces augmentations entraîne des poussées inflationnistes** elle décide d’une augmentation du taux d'intérêt ce qui entraîne alors une appréciation de la monnaie. L’évolution nette de l’investissement est alors ambigu et **la balance commerciale se dégrade par le canal du produit intérieur et du taux de change**. 
- De même, une **politique monétaire restrictive** implique une diminution du produit, une augmentation du taux d'intérêt et une appréciation de la monnaie.
- La **combinaison de la contraction monétaire et de l’expansion budgétaire** est illustrée par la politique économique de Reagan durant les années 1980 (soutenue par les économistes de l’offre dont Arthur LAFFER) qui explique le **problème des déficits jumeaux** (budgétaire et commercial). 

<div style="page-break-after: always;"></div>



> [!seealso] Les politiques macroéconomiques dans le cadre du modèle *IS/LM* en économie ouverte
> ![[Pasted image 20240220190140.png|center]]

<div style="page-break-after: always;"></div>


- La plupart des économistes étaient en désaccord avec la **politique commerciale de l’administration Trump** en 2018 visant à réduire le déficit commercial **du point de vue du diagnostic** (le déficit commercial est lié à la faiblesse de l’épargne intérieure et à l’attractivité des capitaux américains non à la Chine) et **du point de vue de la méthode** (l’instauration de droits de douane en raison de mesures de représailles, de tensions inflationnistes intérieures si le produit est proche de son niveau potentiel, des anticipations et de la réforme fiscale de Trump aggravant le déficit budgétaire et donc une dégradation du solde commercial). 

### 5. Les taux de change fixes 

- Les banques centrales ne laissent pas les taux de change se fixer seuls mais cherchent à maintenir des **objectifs implicites ou explicites de taux de change** atteints par la politique monétaire. 
- Il existe plusieurs types de régimes de change. Ils vont du **taux de change complètement flexible** (États-Unis, Japon) aux **parités glissantes**, aux **ancrages** notamment sur l’euro, aux **taux de change fixes**, jusqu'à l'adoption d'une **monnaie unique**. En régime de change fixe, un pays main- tient un taux de change fixe avec une monnaie étrangère ou avec un panier de devises.
- En **régime de change fixe** et **si les capitaux sont parfaitement mobiles**, un pays doit maintenir son taux d'intérêt égal au taux d'intérêt étranger. **Ainsi, la banque centrale perd un instrument de politique: la politique monétaire. La politique budgétaire devient plus efficace**, parce qu'elle provoque une accommodation monétaire et donc ne permet pas à l'évolution des taux de change et des taux d'intérêt de contrecarrer en partie l'augmentation initiale du produit.
- ⚠ En régime de change fixe, une augmentation du taux de change est appelée une **dévaluation** (au lieu d’une dépréciation) et une diminution du taux de change est nommée **réévaluation**. 
- Fixer son taux de change apparaît à court terme comme une mauvaise idée : 
	- **On se prive d’un instrument de correction de la balance commerciale ou de relance**
	- **On perd le contrôle du taux d’intérêt et on doit suivre le taux d’intérêt étranger** au risque de distorsions (crise de change du SME en 1992 avec l’augmentation du *i* allemand après la réunification pour éviter la surchauffe. Les autres pays se calent sur la *Bundesbank* ce qui entraîne un ralentissement de l’activité et un fort chômage).  
	- **On perd l’instrument de la politique monétaire** et donc la possibilité d’un *policy mix*. 
- Mais pour comprendre pourquoi certains pays fixent leur taux de change il faut étudier à moyen terme les avantages et inconvénients des régimes de change. 
